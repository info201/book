...
```{r fig.align='left', echo=FALSE, include=identical(knitr:::pandoc_to(), 'html'), fig.cap="The local git process."}
#to include only in html (centered)
knitr::include_graphics('img/git-basics/local-process.gif', dpi = NA)
#TODO: Fix figure caption?
```
...
```{r fig.align='left', echo=FALSE, include=identical(knitr:::pandoc_to(), 'html'), fig.cap="The remote git process."}
#to include only in html (centered)
knitr::include_graphics('img/git-basics/remote-process.gif', dpi = NA)
#TODO: Fix figure caption?
```
