...
- **`eval`** determines whether or not you want the code to be evaluated (default=TRUE). This may be helpful if you want to show someone a code example, but don’t want to execute it.
