...
_one-dimensional collection of data_. However, lists have a few major differences from vectors:
...
names(person_alt) <- c("name", "work", "income", "memebership")
```
This is usually more error-prone and harder way to create lists
