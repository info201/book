...
Alternatively, the latest updates to Windows 10 (August 2016 or later) _does_ includes a beta version of an integrated Bash shell. You can access this by [enabling the subsystem for Linux](https://msdn.microsoft.com/en-us/commandline/wsl/install_guide) and then running `bash` in the command prompt.
